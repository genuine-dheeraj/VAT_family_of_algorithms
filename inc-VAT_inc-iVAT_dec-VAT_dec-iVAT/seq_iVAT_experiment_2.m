...
[~,idx]=sort(data_matrix_with_lables(:,3));
data_matrix_with_lables=data_matrix_with_lables(idx,:);
dist_matrix=dist_matrix(idx,idx);
...
outputVideo = VideoWriter('ivat_image_movie_2','MPEG-4');
